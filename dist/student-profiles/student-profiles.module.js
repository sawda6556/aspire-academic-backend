...
exports.StudentProfilesModule = StudentProfilesModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([student_profile_entity_1.StudentProfile]), mail_module_1.MailModule],
        controllers: [student_profiles_controller_1.StudentProfilesController],
        providers: [student_profiles_service_1.StudentProfilesService],
        exports: [student_profiles_service_1.StudentProfilesService],
    })
