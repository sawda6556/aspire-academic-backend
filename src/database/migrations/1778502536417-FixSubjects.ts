...
export class FixSubjects1778502536417 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."subjects_category_enum" AS ENUM('ACADEMIC', 'ISLAMIC', 'LANGUAGES', 'SKILLS', 'PRIMARY', 'SECONDARY', 'A_LEVEL', 'UNIVERSITY', 'SPECIAL_SUPPORT', 'OTHER')`);
        await queryRunner.query(`CREATE TYPE "public"."subjects_level_enum" AS ENUM('GENERAL', 'BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'PRIMARY', 'SECONDARY', 'KS1', 'KS2', 'GCSE', 'A_LEVEL', 'UNIVERSITY')`);
